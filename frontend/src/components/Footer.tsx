  ...
  return (
    ...
    >
      <div className="page-wrap flex flex-col items-center justify-between gap-2 text-center sm:flex-row sm:text-left">
        <p className="m-0 text-xs">&copy; {year}.</p>
        <p className="island-kicker m-0">
          <a
            href="https://github.com/JoshuaChelen/henhackathon26"
            target="_blank"
            rel="noreferrer"
          >Made for HenHacks 2026.</a>
        </p>
      </div>
      <div className="mt-2 flex justify-center gap-2">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="rounded-xl p-1 text-[var(--sea-ink-soft)] transition hover:bg-[var(--link-bg-hover)] hover:text-[var(--sea-ink)]"
        >
